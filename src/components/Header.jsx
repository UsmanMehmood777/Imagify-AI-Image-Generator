...
const Header = () => {
  return (
    <div className= 'flex flex-col justify-center items-center text-center my-20'>
      ...
      <p className='text-center max-w-xl mx-auto mt-5'>Uleash your
        Creativity with our AI-powered text-to-image generator. Transform your ideas into stunning visuals in seconds. Try it now and bring your imagination to life!</p>
    
    <button className='sm:text-lg text-white bg-black
    w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'>
        Generate Images
