...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >Uleash your
        Creativity with our AI-powered text-to-image generator. Transform your ideas into stunning visuals in seconds. Try it now and bring your imagination to life!</motion.p>
