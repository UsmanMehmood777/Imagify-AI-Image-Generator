...
const Description = () => {
  return (
    ...
    justify-center my-24- p-4 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'> 
        ...
        <div>
        <h2 className='text-3xl font-medium max-w-lg mb-4'> Introducing Our AI Text to Image Generator</h2>
        <p className='text-gray-600 mb-4'> Easily bring your ideas to life with our free
            AI Image Generator, Whether you need stunning
            visuals or unique imagery, out tool transforms
            ...
            <p className='text-gray-600'> Simply type in a text prompt, and our cutting-edge
                ...
                From product visuals to character designs and potraits,
                even ceoncepts that don't exist yet, can be visualized effortlessly.
